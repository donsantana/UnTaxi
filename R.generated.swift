...
struct _R {
  ...
  struct storyboard {
    ...
    var transporVIPLaunchScreen: transporVIPLaunchScreen { .init(bundle: bundle) }
    ...
    func transporVIPLaunchScreen(bundle: Foundation.Bundle) -> transporVIPLaunchScreen {
      .init(bundle: bundle)
    }
    func validate() throws {
      ...
      try self.transporVIPLaunchScreen.validate()
    }
    ...
    /// Storyboard `TransporVIP Launch Screen`.
    struct transporVIPLaunchScreen: RswiftResources.StoryboardReference, RswiftResources.InitialControllerContainer {
      typealias InitialController = UIKit.UIViewController

      let bundle: Foundation.Bundle

      let name = "TransporVIP Launch Screen"
      func validate() throws {
        if UIKit.UIImage(named: "launch", in: bundle, compatibleWith: nil) == nil { throw RswiftResources.ValidationError("[R.swift] Image named 'launch' is used in storyboard 'TransporVIP Launch Screen', but couldn't be loaded.") }
      }
    }
  }
}