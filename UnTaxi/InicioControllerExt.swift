...
//    anotationView = MKAnnotationView(annotation: self.origenAnotacion as! MKAnnotation, reuseIdentifier: "annotationView")
//        if annotation.title! == "origen"{
//            self.mapView.removeAnnotation(self.origenAnotacion)
...
//    }
//
//  @nonobjc func mapView(_ mapView: MKMapView, regionWillChangeAnimated animated: Bool) {
...
//    }
//
//  @nonobjc func mapView(_ mapView: MKMapView, regionDidChangeAnimated animated: Bool) {
//        origenIcono.isHidden = true
//        if SolicitarBtn.isHidden == false {
//            miposicion.coordinate = (self.mapView.centerCoordinate)
//            origenAnotacion.title = "origen"
//          mapView.addAnnotation(self.miposicion as! MKAnnotation)
//        }
//    }
//}
