...
//  }
  ...
  func crearTrama() -> [String:Any]{
    ...
    if self.tipoServicio == 1 || self.useVoucher == "1"{
      tramaBase["dirdestino"] = self.dirDestino
      tramaBase["latdestino"] = self.destinoCoord.latitude
      tramaBase["lngdestino"] = self.destinoCoord.longitude
