...
//              let result = data[0] as! Dictionary<String, AnyObject>
...
//  }
  ...
  func crearSolicitudOferta(){
    ...
    if !self.origenCell.origenText.text!.isEmpty{
      ...
      let destino = self.destinoCell.destinoText.text!.isEmpty ? "" : self.cleanTextField(textfield: self.destinoCell.destinoText)
